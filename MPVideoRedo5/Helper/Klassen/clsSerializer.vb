...
Public Class clsSerializer
    Public Shared Sub Serialize(Of T)(ByVal compression As Boolean, ByVal path As String, ByVal instance As T)
    ...
    Public Shared Function DeSerialize(Of T)(ByVal compression As Boolean, ByVal path As String, ByVal defaultInstance As T) As T
    ...
    Public Shared Function DeSerialize(Of T As New)(ByVal compression As Boolean, ByVal path As String) As T
