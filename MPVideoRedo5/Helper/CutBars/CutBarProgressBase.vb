...
<Serializable()> Public MustInherit Class CutBarProgressBase
    Inherits Control
...
#Region "public events"
    ...
    ''' </summary>
    Public Event StartValueChanged(ByVal sender As Object, ByVal e As CutBarProgressEventArgs)

    ''' <summary>
    ''' Fired, when ending value changed
    ''' </summary>
    Public Event EndValueChanged(ByVal sender As Object, ByVal e As CutBarProgressEventArgs)

    ''' <summary>
    ''' Fired, when changed the LineMarkerthickness or Position
    ''' </summary>
    Public Event LineMarkerChanged(ByVal sender As Object, ByVal e As CutBarProgressEventArgs)
...
#Region "properties"
    ...
    Public Overridable Property Style() As SpecialProgressBarStyle
        ...
        Set(ByVal value As SpecialProgressBarStyle)
            If Me.m_style <> value Then
                Me.m_style = value
                Invalidate()
                OnStyleChanged(New CutBarProgressEventArgs)
            End If
        End Set
    End Property
    ...
    Public Overridable Property LightFillColor() As Color
        ...
        Set(ByVal value As Color)
            If Me.m_lightFillColor <> value Then
                ...
                Invalidate()
                OnLightFillColorChanged(New CutBarProgressEventArgs)
            End If
        End Set
    End Property
    ...
    Public Overridable Property DarkFillColor() As Color
        ...
        Set(ByVal value As Color)
            If Me.m_darkFillColor <> value Then
                ...
                Invalidate()
                OnDarkFillColorChanged(New CutBarProgressEventArgs)
            End If
        End Set
    End Property
    ...
    Public Overridable Property LightBackColor() As Color
        ...
        Set(ByVal value As Color)
            If Me.m_lightBackColor <> value Then
                ...
                Invalidate()
                OnLightBackColorChanged(New CutBarProgressEventArgs)
            End If
        End Set
    End Property
    ...
    Public Overridable Property DarkBackColor() As Color
        ...
        Set(ByVal value As Color)
            If Me.m_darkBackColor <> value Then
                ...
                Invalidate()
                OnDarkBackColorChanged(New CutBarProgressEventArgs)
            End If
        End Set
    End Property
    ...
    Public Overridable Property StartCutValues() As List(Of Single)
        ...
        Set(ByVal value As List(Of Single))
            ...
            Invalidate()
            OnStartValueChanged(New CutBarProgressEventArgs)
        End Set
    End Property
    ...
    Public Overridable Property EndCutValues() As List(Of Single)
        ...
        Set(ByVal value As List(Of Single))
            ...
            Me.m_endValue = value
            Invalidate()
            OnEndValueChanged(New CutBarProgressEventArgs)
        End Set
    End Property
    ''' <summary>
    ...
    Public Overridable Property LineMarkerColor() As Color
        Get
    ...
    <Editor(GetType(CutBarProgressValueProperty), GetType(UITypeEditor))> _
...
#Region "protected members"
    ...
    ''' Fired, when starting value changed
    ''' </summary>
    Protected Sub OnStartValueChanged(ByVal e As CutBarProgressEventArgs)
    ...
    ''' Fired, when ending value changed
    ''' </summary>
    Protected Sub OnEndValueChanged(ByVal e As CutBarProgressEventArgs)
        e.StartValues = Me.StartCutValues
        e.EndValues = Me.EndCutValues
        e.LineMarkerPosition = Me.LineMarkerPosition
    ...
    ''' </summary>
    Protected Sub OnLineMarkerChanged(ByVal e As CutBarProgressEventArgs)
        e.StartValues = Me.StartCutValues
        e.EndValues = Me.EndCutValues
        e.LinemarkerPosition = Me.LineMarkerPosition
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        Using brush As New SolidBrush(Color.FromArgb(48, Color.White))
            g.SetClip(path)
            g.FillRectangle(brush, New RectangleF(rect.X, rect.Y, rect.Width, rect.Height / 2))
            g.ResetClip()
        End Using
        'Marker
        ...
        If Text.Length > 0 Then
            ...
            Dim fontRect As New RectangleF(rect.X + rect.Width / 2 - fontSize.Width / 2, rect.Y + rect.Height / 2 - fontSize.Height / 2, fontSize.Width, fontSize.Height)
