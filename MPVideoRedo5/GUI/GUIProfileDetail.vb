...
Namespace MPVideoRedo5
    Public Class GUIProfileDetail
        ...
        Private AktProfile As VideoReDo5.VRDProfileInfo
...
#Region "MP EventSubs"
        ...
        Public Overloads Overrides Function Init() As Boolean
            Return Load(GUIGraphicsContext.Skin + "\MPVideoRedo5.ProfileDetail.xml")
        End Function
        ...
        Protected Overrides Sub OnClicked(ByVal controlId As Integer, ByVal control As MediaPortal.GUI.Library.GUIControl, ByVal actionType As MediaPortal.GUI.Library.Action.ActionType)
            If control Is btnUseIt Then
                ...
                PageDestroy()
            Else
                AktProfile.Profilename = VRD.SavingProfile
                PageDestroy()
            End If
