...
Public Class SetupForm
    ...
    Private Sub SetupForm_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        ...
        HelpConfig.SetConfigString(ConfigKey.AlwaysSaveProject, Me.chkAlwaysSaveProject.Checked)
        HelpConfig.SetConfigString(ConfigKey.AlwaysLoadComSkipMarkers, Me.chkAlwaysLoadComSkipMarkers.Checked)
        HelpConfig.SetConfigString(ConfigKey.AlwaysLoadProject, Me.chkAlwaysLoadProject.Checked)
        ...
        HelpConfig.SetConfigString(ConfigKey.AlwaysSaveComSkipMarkers, Me.chkAlwaysSaveComSkipMarkers.Checked)
        HelpConfig.SetConfigString(ConfigKey.PauseOnStart, Me.chkPauseOnStart.Checked)
    End Sub
    ...
    Private Sub SetupForm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me.chkAlwaysSaveProject.Checked = HelpConfig.GetConfigString(ConfigKey.AlwaysSaveProject)
        Me.chkAlwaysKeepOriginalFile.Checked = HelpConfig.GetConfigString(ConfigKey.AlwaysKeepOriginalFile)
        Me.chkAlwaysLoadComSkipMarkers.Checked = HelpConfig.GetConfigString(ConfigKey.AlwaysLoadComSkipMarkers)
        Me.chkAlwaysLoadProject.Checked = HelpConfig.GetConfigString(ConfigKey.AlwaysLoadProject)
        ...
        Me.chkAlwaysSaveComSkipMarkers.Checked = HelpConfig.GetConfigString(ConfigKey.AlwaysSaveComSkipMarkers)
        Me.chkPauseOnStart.Checked = HelpConfig.GetConfigString(ConfigKey.PauseOnStart)
    ...
    Private Sub TranslateSetupForm()
        ...
        Me.chkPauseOnStart.Text = Translation.PauseOnStart
        Me.GroupBoxDialogs.Text = Translation.GroupDialogs
        Me.chkDisableProfileDetails.Text = Translation.DisableProfileDetails
        Me.chkAlwaysSaveProject.Text = Translation.AlwaysSaveProject
        Me.chkAlwaysKeepOriginalFile.Text = Translation.AlwaysKeepOriginalFile
        Me.chkAlwaysLoadComSkipMarkers.Text = Translation.AlwaysLoadComSkipmarkers
        Me.chkAlwaysLoadProject.Text = Translation.AlwaysLoadProject
        ...
        Me.chkAlwaysSaveComSkipMarkers.Text = Translation.AlwaysSaveComSkipMarkers
        ...
        Me.tabVRD.Text = Translation.VRD
        Me.lblDescriptionVRD.Text = Translation.DescriptionVRDProfiles
        Me.btnCheckVRD.Text = Translation.ButtonCheckVRD
        Me.chkDebugMode.Text = Translation.DebugMode
        Me.GroupBoxVRDProfile.Text = Translation.GroupVRDProfile
        ...
        Me.GroupBoxVRDProfileH264.Text = Translation.GroupVRDProfileH264
    ...
    Private Sub imgAlwaysSaveProject_Click(sender As Object, e As EventArgs) Handles imgAlwaysSaveProject.Click
        MsgBox(Translation.HelpAlwaysSaveProject)
    End Sub

    Private Sub imgAlwaysKeepOriginalFile_Click(sender As Object, e As EventArgs) Handles imgAlwaysKeepOriginalFile.Click
        MsgBox(Translation.HelpAlwaysKeepOriginalFile)
    End Sub

    Private Sub imgAlwaysLoadComSkipMarkers_Click(sender As Object, e As EventArgs) Handles imgAlwaysLoadComSkipMarkers.Click
        MsgBox(Translation.HelpAlwaysLoadComSkipMarkers)
    End Sub

    Private Sub imgAlwaysSaveComSkipMarkers_Click(sender As Object, e As EventArgs) Handles imgAlwaysSaveComSkipMarkers.Click
        MsgBox(Translation.HelpAlwaysSaveComSkipMarkers)
    End Sub

    Private Sub imgAlwaysRefreshMoviestripThumbs_Click(sender As Object, e As EventArgs) Handles imgAlwaysRefreshMoviestripThumbs.Click
        MsgBox(Translation.HelpAlwaysRefreshMoviestripThumbs)
    End Sub

    Private Sub imgPauseOnStart_Click(sender As Object, e As EventArgs) Handles imgPauseOnStart.Click
        MsgBox(Translation.HelpPauseOnStart)
    End Sub

    Private Sub imgAlwaysLoadProject_Click(sender As Object, e As EventArgs) Handles imgAlwaysLoadProject.Click
        MsgBox(Translation.HelpAlwaysLoadProject)
    End Sub

    Private Sub imgDonate_Click(sender As Object, e As EventArgs) Handles Donate.Click
        Dim p As Process = Process.Start("https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=E3VLCRZUMADRU")
    End Sub
    ...
    Dim VRD As VideoReDo5
    Private Sub btnCheckVRD_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCheckVRD.Click
        Me.Cursor = Windows.Forms.Cursors.WaitCursor
        Try
            VRD = New VideoReDo5
            If Strings.Left(VRD.ReDoVersion, 1) = 5 Then
                Me.btnCheckVRD.Enabled = False
                Dim ProfileList As List(Of String) = VRD.GetProfileList
                For Each item In ProfileList
                    Me.cbxSavingProfile.Items.Add(item)
                    Me.cbxSavingProfileH264.Items.Add(item)
                Next
                Me.GroupBoxVRDProfile.Visible = True
                Me.GroupBoxVRDProfileH264.Visible = True
                For Each item In cbxSavingProfile.Items
                    If item = HelpConfig.GetConfigString(ConfigKey.VRDProfile) Then
                        cbxSavingProfile.SelectedItem = item
                        Exit For
                    End If
                Next
                For Each item In cbxSavingProfileH264.Items
                    If item = HelpConfig.GetConfigString(ConfigKey.VRDProfileH264) Then
                        cbxSavingProfileH264.SelectedItem = item
                        Exit For
                    End If
                Next
            Else
                MsgBox("VRD 5 is not active on your system")
                Me.btnCheckVRD.Enabled = False
            End If
    ...
    Private Sub cbxSavingProfile_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbxSavingProfile.SelectedIndexChanged
        Me.Cursor = Windows.Forms.Cursors.WaitCursor
        HelpConfig.SetConfigString(ConfigKey.VRDProfile, Me.cbxSavingProfile.Text)
        Dim AktProfile As VideoReDo5.VRDProfileInfo
        AktProfile = VRD.GetProfileInfo(Me.cbxSavingProfile.Text)
    ...
    Private Sub cbxSavingProfileH264_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbxSavingProfileH264.SelectedIndexChanged
        Me.Cursor = Windows.Forms.Cursors.WaitCursor
        HelpConfig.SetConfigString(ConfigKey.VRDProfileH264, Me.cbxSavingProfileH264.Text)
        Dim AktProfile As VideoReDo5.VRDProfileInfo
        AktProfile = VRD.GetProfileInfo(Me.cbxSavingProfileH264.Text)
